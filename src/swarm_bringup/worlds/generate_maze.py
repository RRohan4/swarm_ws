...
_a("    <!-- Scene -->")
_a("    <scene>")
_a("      <ambient>0.5 0.5 0.5 1</ambient>")
_a("      <background>0.3 0.4 0.55 1</background>")
_a("      <shadows>true</shadows>")
_a("      <grid>false</grid>")
_a("    </scene>")
_a("")
_a("    <!-- Sun — warm-tinted so R!=G!=B and cameras produce visible color -->")
_a('    <light type="directional" name="sun">')
_a("      <cast_shadows>true</cast_shadows>")
_a("      <pose>0 0 20 0 0 0</pose>")
_a("      <diffuse>1.0 0.95 0.8 1</diffuse>")
_a("      <specular>0.4 0.4 0.3 1</specular>")
_a("      <attenuation>")
_a("        <range>1000</range>")
...
_a("          </geometry>")
_a("          <material>")
_a("            <ambient>0.35 0.28 0.20 1</ambient>")
_a("            <diffuse>0.55 0.45 0.30 1</diffuse>")
_a("          </material>")
_a("        </visual>")
_a("      </link>")
_a("    </model>")
...
for idx, (lx, ly, sx, sy) in enumerate(wall_runs):
    ...
    _a(geom)
    _a("          <material>")
    _a("            <ambient>0.45 0.45 0.55 1</ambient>")
    _a("            <diffuse>0.70 0.70 0.85 1</diffuse>")
    _a("            <specular>0.15 0.15 0.2 1</specular>")
    _a("          </material>")
    _a("        </visual>")
    _a("      </link>")
